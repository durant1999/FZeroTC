...
def cluster_eval(labels=[1,1,2,2,3,3,3,3],pred_labels_list=[1,3,2,2,1,1,1,1],new_class_index_start=2,new_class_index_end=4):
    ...
    # labels=[1,1,2,2,3,3,3,3,2,2]
    # pred_labels_list=[1,3,2,2,1,1,1,1,4,4]
    
    # preprocessed_matrix = preprocess4Hungarian(labels,pred_labels_list)
    ...
    # print(NMI_pred_labels)
    # print(NMI_gt_labels)
    #  - H_assign_NMI   - H_notassign_NMI
    # H_assign_NMI
...
def seamantic_eval(target_word_list, pred_word_list, top_num=1):
    # [(' Technology', 146), (' Tech', 141), (' Business', 118), (' IT', 87)]
    ...
    # print("top_{} mean similarity to target topic words : {}".format(top_num,sim_total/counts))
